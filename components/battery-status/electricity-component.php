...
<div class="panel-section">
    <div class="panel-section-title">
        <h5 class="center">Electricity Status</h5>
    </div>
    <div class="panel-section-data">
        <ul>
            <li>
                <h5>Smart Plug 1 _ Computer 1</h5>
            </li>
            <li>
            ...
            <li>
                <h5>Smart Plug 2 _ Computer 2</h5>
            </li>
            <li>
                <div class="electricity-status">
                    <div class="voltage">
            ...
            <li>
                <h5>Smart Plug 3 _ Computer 3</h5>
            </li>
            <li>
                <div class="electricity-status">
                    <div class="voltage">
            ...
            <li>
                <h5>Smart Plug 4 _ Computer 4</h5>
            </li>
            <li>
                <div class="electricity-status">
                    <div class="voltage">
            ...
            <li>
                <h5>Smart Plug 5 _ Dispenser</h5>
            </li>
            <li>
                <div class="electricity-status">
                    <div class="voltage">
            ...
            <li>
                <h5>Smart Plug 6 _ Refrigerator</h5>
            </li>
            <li>
                <div class="electricity-status">
                    <div class="voltage">
