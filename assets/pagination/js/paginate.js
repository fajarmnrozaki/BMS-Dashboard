...
function lignePaginate() {
    ...
    var initTable = function (el) {
        if (el.indexOf('#') > -1) {
            ...
            // console.log("LLLLL", settings.table)
        } else if (el.indexOf('.') > -1) {
            settings.table = document.querySelector(el);
            // console.log("KKKK", settings.table)
        }
    }
    ...
    var paginateAlreadyExists = function () {
        ...
        if (paginate != null) {
            // console.log("3333", document.querySelector('div.paginate'));
    ...
    var removePaginate = function (element) {
        ...
        console.log("5555", document.querySelector('div.paginate'));
